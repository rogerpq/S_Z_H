...
PMPERMIT_MESSAGE = (
    "**هلا حياتي ،..\n**"
    "**~ يمكن نايم او مشغول**"
    "**حط رسالتك وانتضر الموافقة!.\n\n**"
    "**~ لاتلح بالرسائل لان عندك جم تحذير اذا تجاوزتهم راح تنحظر!**"
)

BLOCKED = "**عزيزي تذكر حذرتك وكلتلك عندك جم تحذريات وانت تجاوزتها\nعبالك اخليك تكرر؟\nراح اقوم بحظرك وبعد ماتكدر تدز رسائل اله مايجي صاحب الحساب ويوخر الحظر منك!❤️**"
